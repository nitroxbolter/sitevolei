...
// Obter todos os torneios ativos (incluindo 'Criado')
$sql = "SELECT t.*, g.nome as grupo_nome, u.nome as criado_por_nome,
        ...
        WHERE t.status IN ('Criado', 'Inscrições Abertas', 'Em Andamento')
        GROUP BY t.id
            ...
            <div class="row" id="torneios-container">
                <?php foreach ($torneios as $torneio): ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 torneio-card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <strong>Grupo:</strong> <?php echo htmlspecialchars($torneio['grupo_nome'] ?: 'Avulso'); ?>
                                </p>
